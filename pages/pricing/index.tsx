    ...
    <>
        <NavBar />
            <div className='flex flex-col text-center justify-center bg-white'>
                <h1 className='font-bold mb-6 mt-4 text-[1.9em] lg:text-[2em] md:text-[2em] lg:w-[37%] md:w-[55%] w-[92%] mx-auto text-black'>Pricing built for businesses of all sizes.</h1>
                ...
                <div className='relative bg-slate-100 lg:bg-white md:bg-none py-6 lg:py-0' style={{position: 'relative'}}>
                    ...
                    <div className='border border-slate-200 rounded-md px-1 py-1 w-[18em] bg-[#FCFCFD] flex justify-around gap-3 ml-auto mr-auto'>
                    ...
                    <div className='mt-10 grid lg:grid-cols-3 md:grid-cols-2 gap-6 lg:gap-[4%] md:gap-5 lg:px-[5em] md:px-[2em] px-[1em]'>
                        <div className='flex flex-col rounded-lg bg-white z-[2] text-left lg:mb-[-1.8em] lg:mt-auto md:mt-[2em] p-6 pb-10 transition-all duration-300 lg:scale-90 lg:h-[27em] cursor-pointer border border-slate-300'>
                            ...
                            <button className='font-bold text-[0.9em] text-[#7B61FF] border-2 transition-all duration-300 border-[#7B61FF] hover:bg-[#7B61FF] hover:text-white rounded-md lg:mb-[1em] mt-auto p-2'>Choose this plan</button>
                        </div>
                        ...
                        {/* <div className='flex flex-col rounded-lg bg-white z-[2] text-left lg:mb-[-1.5em] lg:mt-auto md:mt-[2em] p-6 pb-10 transition-all duration-300 lg:scale-90 lg:h-[27em] cursor-pointer border border-slate-300'> */}
                        ...
                        <div className='flex flex-col rounded-lg bg-white z-[2] text-left lg:mt-auto lg:mb-[-1.5em] md:mt-[2em] p-6 pb-10 transition-all duration-300 lg:scale-90 lg:h-[27em] cursor-pointer border border-slate-300'>
                            ...
                            <button className='font-bold text-[0.9em] text-[#7B61FF] border-2 transition-all duration-300 border-[#7B61FF] hover:bg-[#7B61FF] hover:text-white rounded-md mt-auto p-2'>Contact us</button>
                        </div>
                    </div>
                </div>
                ...
                <div className='pt-12 lg:px-[5em] md:px-[2em] px-[1em] z-[2] bg-white'>
                    ...
                    <div className='grid mt-8 lg:grid-cols-3 gap-4 my-5 md:grid-cols-2'>
                        ...
                        <div className='text-left rounded-md bg-[#FFE8F0] bg-opacity-40 p-6 h-[14em] md:h-auto'>
                            <p className='pb-2 font-bold text-[#551E33]'>Is there a free trial available</p>
                            <p className='text-[#551E33] font-light md:font-normal'>Yes, you can try us for free for 30 days. If you want, we’ll 
                            provide you with a free, personalized 30-minute onboarding call to get you up and running as soon as possible.</p>
                        </div>
                        <div className='text-left rounded-md bg-[#E4DFFF] bg-opacity-40 p-6 h-[14em] md:h-auto'>
                            <p className='pb-2 font-bold text-[#3D3080]'>Can I change my plan later?</p>
                            <p className='text-[#292055] font-light md:font-normal'>Of course. Our pricing scales with your company. Chat to our friendly team to find a solution that works for you.</p>
                        </div>
                        <div className='text-left rounded-md bg-[#D1E9FF] bg-opacity-40 p-6 h-[14em] md:h-auto'>
                            <p className='pb-2 font-bold text-[#1849A9]'>What is your cancellation policy?</p>
                            <p className='text-[#194185] font-light md:font-normal'>We understand that things change. You can cancel your plan at any time and we’ll refund you the difference already paid.</p>
                        </div>
                        <div className='text-left rounded-md bg-[#D1E9FF] bg-opacity-40 p-6 h-[14em] md:h-auto'>
                            <p className='pb-2 font-bold text-[#1849A9]'>Can I change my plan later?</p>
                            <p className='text-[#194185] font-light md:font-normal'>Of course. Our pricing scales with your company. Chat to our friendly team to find a solution that works for you.</p>
                        </div>
                        <div className='text-left rounded-md bg-[#FFE8F0] bg-opacity-40 p-6 h-[14em] md:h-auto'>
                            <p className='pb-2 font-bold text-[#551E33]'>Is there a free trial available</p>
                            <p className='text-[#551E33] font-light md:font-normal'>Yes, you can try us for free for 30 days. If you want, we'll 
                ...
                {/* Contact Us Section */}
                <div className='relative lg:mx-[5em] md:mx-[2em] mx-[1em] my-[4em] bg-[#6651D4] py-10 lg:py-6 md:py-6 rounded-xl'>
                    ...
                    <p className=' font-bold pt-4'>Still have questions?</p>
                    <p className='lg:w-[50%] md:w-[50%] w-[90%] mt-2 font-thin'>if you're unable to find the answer you're seeking please feel free to chat with our friendly team for further assistance.</p>
                ...
                <div className='pb-[3em] px-[1em] flex flex-col items-center'>
                    ...
                    <p className='w-[85%] lg:w-[30%] text-slate-500'>Get started with us today and get access to lorem ipsum dolor sit amet</p>
